...
export function StickyCTA() {
  ...
  return (
    <aside className="fixed right-3 md:right-5 top-1/2 -translate-y-1/2 z-40 flex flex-col items-center">
      ...
      >
        <span className="bubble-bob relative rounded-full bg-brand-red px-3 py-1 text-[11px] font-semibold leading-none text-white shadow-[0_8px_20px_-8px_rgba(200,16,46,.7)]">
          {bubble}
          <span aria-hidden className="absolute left-1/2 -bottom-1 h-2 w-2 -translate-x-1/2 rotate-45 bg-brand-red" />
        </span>
        <Image
