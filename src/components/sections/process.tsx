...
export function Process() {
  const { t } = useSite();
  return (
    <section className="py-16 sm:py-24 md:py-36 bg-brand-blue text-white relative overflow-hidden">
      ...
      <Container className="relative">
        <div className="reveal max-w-[42ch] mb-12 md:mb-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10">
          {t.process.steps.map((s, i) => (
            <div
              key={i}
              className="reveal bg-brand-blue p-7 md:p-9 min-h-[220px] md:min-h-[320px] flex flex-col transition-colors duration-500 hover:bg-brand-blue-deep relative group"
